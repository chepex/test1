...
public class MovDpPK implements Serializable {
    ...
    public MovDpPK(short codCia, long secuencia, int codEmp, short codDp) {
	this.codCia = codCia;
	...
	return "com.entities.MovDpPK[ codCia=" + codCia + ", secuencia=" + secuencia + ", codEmp=" + codEmp + ", codDp=" + codDp + " ]";
    }
