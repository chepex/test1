...
public class ResumenAsistenciaPK implements Serializable {
    ...
    public ResumenAsistenciaPK(short codCia, long secuencia, int codEmp) {
	this.codCia = codCia;
	...
	return "com.entities.ResumenAsistenciaPK[ codCia=" + codCia + ", secuencia=" + secuencia + ", codEmp=" + codEmp + " ]";
    }
